...
public class Road_Toll {
	...
	//construtor is not a member of the class. its just called whenever we create an object . used to onitialis ethe variables.
	//Multiple constaructors and that concept is called constructor overloading.
